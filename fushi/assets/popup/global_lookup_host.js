...
(function () {
  ...
  // BUG-1779 follow-up — the native host owns two physical lookup windows and
  ...
  function ensureStyle() {
    ...
    // comes from SetWindowRgn + the fixed shell's one inset border, with nothing
    // painted outside the card. All rules scoped to .global-lookup-frame-shell -> the
  ...
  // BUG-1779 — clipboard history belongs to desktop/global lookup and the
  ...
  function renderStack(payload) {
    ...
    // BUG-1779 — this bit identifies the originating UI surface, not merely the
